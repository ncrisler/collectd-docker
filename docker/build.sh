...
cd /go/src/github.com/ncrisler/collectd-docker/collector
godep restore
go get github.com/ncrisler/collectd-docker/collector/...
...
cp /go/src/github.com/ncrisler/collectd-docker/docker/collectd.conf.tpl /etc/collectd/collectd.conf.tpl
cp /go/src/github.com/ncrisler/collectd-docker/docker/run.sh /run.sh
